...
def ReadPdb( PdbFile ):
    """Reads a PDB file with a name provided in the argument. Assumes the PDB file contains only ATOM and TER entries; TER entries are skipped.
RETURNS:
...
def ResHydrophobic( ResNames ):
    """Take list of three letter codes  for residue names; returns a list, IsPhobic, of True/False values depending on whether residues are hydrophobic or not."""
...
if __name__=='__main__':
    ...
    #Note for testing purposes you should pick a particular PDB file and try your functions on it. In fact, the function for checking residue names can be tested without a PDB file...
